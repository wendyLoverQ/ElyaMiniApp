// 自旋月球 Mini APP：THREE.js 透明背景渲染，离线运行无需联网。
// 月面使用 Solar System Scope 8K 月球贴图（基于 NASA 探测器影像，CC BY 4.0）；
// 昼夜由自定义 shader 的 sunDirection 决定。月球无大气、无灯光，夜面仅保留微弱表面轮廓。
...
if (!(stage instanceof HTMLElement)) throw new Error('自旋月球页面结构不完整')
...
const colorMap = loader.load('textures/moon_day_8k.jpg')
